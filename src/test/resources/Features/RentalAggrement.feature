...
Feature: Rental Agreement page interation
As a tester,
I want to validate the Rental Agreement page
  ...
  Scenario: User views Next Day Delivery option
    ...
    Then the user should enter "Chennai"
...
Examples:
    ...
    | 9403115122  | Ayesha      | ayesha19249@example.com    |
    | 8900037757  | Lahari        | lahari@example.com       |
